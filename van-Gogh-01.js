...
var _user$project$VanGogh$send = function (msg) {
	return A3(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_user$project$VanGogh$info)
					])),
...
var _user$project$VanGogh$getPolygons = _elm_lang$core$Native_Platform.outgoingPort(
	'getPolygons',
	function (v) {
		return null;
	});
var _user$project$VanGogh$polygons = _elm_lang$core$Native_Platform.incomingPort(
	'polygons',
	_elm_lang$core$Json_Decode$list(
		_elm_lang$core$Json_Decode$list(
			A3(
				...
				_elm_lang$core$Json_Decode$float))));
var _user$project$VanGogh$pixels = _elm_lang$core$Native_Platform.incomingPort(
	'pixels',
	A2(
		...
		switch (_p0.ctor) {
			case 'GetData':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$VanGogh$getImageData(
						{ctor: '_Tuple0'})
				};
			case 'GetPolygon':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$VanGogh$getPolygons(
						{ctor: '_Tuple0'})
				};
			case 'MyPolygons':
				return {
...
var _user$project$VanGogh$MyImage = function (a) {
